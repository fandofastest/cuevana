...
import com.livifighter.movieboxcinema.adapters.CastCrewAdapter;
import com.livifighter.movieboxcinema.adapters.CommentsAdapter;
import com.livifighter.movieboxcinema.adapters.EpisodeAdapter;
import com.livifighter.movieboxcinema.adapters.DownloadAdapter;
import com.livifighter.movieboxcinema.adapters.HomePageAdapter;
import com.livifighter.movieboxcinema.adapters.LiveTvHomeAdapter;
import com.livifighter.movieboxcinema.adapters.ProgramAdapter;
import com.livifighter.movieboxcinema.adapters.ServerApater;
import com.livifighter.movieboxcinema.database.DatabaseHelper;
import com.livifighter.movieboxcinema.models.CastCrew;
import com.livifighter.movieboxcinema.models.GetCommentsModel;
import com.livifighter.movieboxcinema.models.CommonModels;
import com.livifighter.movieboxcinema.models.EpiModel;
import com.livifighter.movieboxcinema.models.PostCommentModel;
import com.livifighter.movieboxcinema.models.Program;
import com.livifighter.movieboxcinema.models.SubtitleModel;
import com.livifighter.movieboxcinema.models.single_details.Cast;
import com.livifighter.movieboxcinema.models.single_details.Director;
import com.livifighter.movieboxcinema.models.single_details.DownloadLink;
import com.livifighter.movieboxcinema.models.single_details.Episode;
import com.livifighter.movieboxcinema.models.single_details.Genre;
import com.livifighter.movieboxcinema.models.single_details.RelatedMovie;
import com.livifighter.movieboxcinema.models.single_details.Season;
import com.livifighter.movieboxcinema.models.single_details.SingleDetails;
import com.livifighter.movieboxcinema.models.single_details.Subtitle;
import com.livifighter.movieboxcinema.models.single_details.Video;
import com.livifighter.movieboxcinema.network.RetrofitClient;
import com.livifighter.movieboxcinema.network.apis.CommentApi;
import com.livifighter.movieboxcinema.network.apis.FavouriteApi;
import com.livifighter.movieboxcinema.network.apis.SingleDetailsApi;
import com.livifighter.movieboxcinema.network.apis.SubscriptionApi;
import com.livifighter.movieboxcinema.network.model.ActiveStatus;
import com.livifighter.movieboxcinema.network.model.AdsConfig;
import com.livifighter.movieboxcinema.network.model.FavoriteModel;
import com.livifighter.movieboxcinema.service.DownloadWorkManager;
import com.livifighter.movieboxcinema.utils.PreferenceUtils;
import com.livifighter.movieboxcinema.utils.ApiResources;
import com.livifighter.movieboxcinema.utils.ads.BannerAds;
import com.livifighter.movieboxcinema.utils.Constants;
import com.livifighter.movieboxcinema.utils.ads.PopUpAds;
import com.livifighter.movieboxcinema.utils.ToastMsg;
import com.livifighter.movieboxcinema.utils.Tools;
import com.livifighter.movieboxcinema.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.livifighter.movieboxcinema.Config.API_KEY, userId);
