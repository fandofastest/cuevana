...
import com.hdelitestream.newcuevanahd.adapters.LiveTVAdapter;
...
import com.hdelitestream.newcuevanahd.network.model.Channel;
...
public class ItemTVActivity extends AppCompatActivity {
    ...
    private void loadAd(){
        InterAds ads  = new InterAds(ItemTVActivity.this,false);
