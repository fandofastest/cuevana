package com.hdelitestream.newcuevanahd;
...
import com.hdelitestream.newcuevanahd.adapters.CastCrewAdapter;
import com.hdelitestream.newcuevanahd.adapters.CommentsAdapter;
import com.hdelitestream.newcuevanahd.adapters.EpisodeAdapter;
import com.hdelitestream.newcuevanahd.adapters.DownloadAdapter;
import com.hdelitestream.newcuevanahd.adapters.HomePageAdapter;
import com.hdelitestream.newcuevanahd.adapters.LiveTvHomeAdapter;
import com.hdelitestream.newcuevanahd.adapters.ProgramAdapter;
import com.hdelitestream.newcuevanahd.adapters.ServerApater;
import com.hdelitestream.newcuevanahd.database.DatabaseHelper;
import com.hdelitestream.newcuevanahd.models.CastCrew;
import com.hdelitestream.newcuevanahd.models.GetCommentsModel;
import com.hdelitestream.newcuevanahd.models.CommonModels;
import com.hdelitestream.newcuevanahd.models.EpiModel;
import com.hdelitestream.newcuevanahd.models.PostCommentModel;
import com.hdelitestream.newcuevanahd.models.Program;
import com.hdelitestream.newcuevanahd.models.SubtitleModel;
import com.hdelitestream.newcuevanahd.models.single_details.Cast;
import com.hdelitestream.newcuevanahd.models.single_details.Director;
import com.hdelitestream.newcuevanahd.models.single_details.DownloadLink;
import com.hdelitestream.newcuevanahd.models.single_details.Episode;
import com.hdelitestream.newcuevanahd.models.single_details.Genre;
import com.hdelitestream.newcuevanahd.models.single_details.RelatedMovie;
import com.hdelitestream.newcuevanahd.models.single_details.Season;
import com.hdelitestream.newcuevanahd.models.single_details.SingleDetails;
import com.hdelitestream.newcuevanahd.models.single_details.Subtitle;
import com.hdelitestream.newcuevanahd.models.single_details.Video;
import com.hdelitestream.newcuevanahd.network.RetrofitClient;
import com.hdelitestream.newcuevanahd.network.apis.CommentApi;
import com.hdelitestream.newcuevanahd.network.apis.FavouriteApi;
import com.hdelitestream.newcuevanahd.network.apis.SingleDetailsApi;
import com.hdelitestream.newcuevanahd.network.apis.SubscriptionApi;
import com.hdelitestream.newcuevanahd.network.model.ActiveStatus;
import com.hdelitestream.newcuevanahd.network.model.FavoriteModel;
import com.hdelitestream.newcuevanahd.service.DownloadWorkManager;
import com.hdelitestream.newcuevanahd.utils.PreferenceUtils;
import com.hdelitestream.newcuevanahd.utils.ApiResources;
import com.hdelitestream.newcuevanahd.utils.Constants;
import com.hdelitestream.newcuevanahd.utils.ToastMsg;
import com.hdelitestream.newcuevanahd.utils.Tools;
import com.hdelitestream.newcuevanahd.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.hdelitestream.newcuevanahd.Config.API_KEY, userId);
