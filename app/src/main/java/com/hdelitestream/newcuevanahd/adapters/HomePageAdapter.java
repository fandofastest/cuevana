package com.hdelitestream.newcuevanahd.adapters;
...
import com.hdelitestream.newcuevanahd.DetailsActivity;
import com.hdelitestream.newcuevanahd.LoginActivity;
import com.hdelitestream.newcuevanahd.R;
import com.hdelitestream.newcuevanahd.models.CommonModels;

import com.hdelitestream.newcuevanahd.utils.ItemAnimation;
    ...
    public void onBindViewHolder(final HomePageAdapter.OriginalViewHolder holder, final int position) {
        ...
        holder.lyt_parent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                InterAds interAds = new InterAds(ctx,true);

                interAds.setCustomObjectListener(new InterAds.MyCustomObjectListener() {
                    @Override
