...
import com.movieeeapps.cuevanahd.adapters.CastCrewAdapter;
import com.movieeeapps.cuevanahd.adapters.CommentsAdapter;
import com.movieeeapps.cuevanahd.adapters.EpisodeAdapter;
import com.movieeeapps.cuevanahd.adapters.DownloadAdapter;
import com.movieeeapps.cuevanahd.adapters.HomePageAdapter;
import com.movieeeapps.cuevanahd.adapters.LiveTvHomeAdapter;
import com.movieeeapps.cuevanahd.adapters.ProgramAdapter;
import com.movieeeapps.cuevanahd.adapters.ServerApater;
import com.movieeeapps.cuevanahd.database.DatabaseHelper;
import com.movieeeapps.cuevanahd.models.CastCrew;
import com.movieeeapps.cuevanahd.models.GetCommentsModel;
import com.movieeeapps.cuevanahd.models.CommonModels;
import com.movieeeapps.cuevanahd.models.EpiModel;
import com.movieeeapps.cuevanahd.models.PostCommentModel;
import com.movieeeapps.cuevanahd.models.Program;
import com.movieeeapps.cuevanahd.models.SubtitleModel;
import com.movieeeapps.cuevanahd.models.single_details.Cast;
import com.movieeeapps.cuevanahd.models.single_details.Director;
import com.movieeeapps.cuevanahd.models.single_details.DownloadLink;
import com.movieeeapps.cuevanahd.models.single_details.Episode;
import com.movieeeapps.cuevanahd.models.single_details.Genre;
import com.movieeeapps.cuevanahd.models.single_details.RelatedMovie;
import com.movieeeapps.cuevanahd.models.single_details.Season;
import com.movieeeapps.cuevanahd.models.single_details.SingleDetails;
import com.movieeeapps.cuevanahd.models.single_details.Subtitle;
import com.movieeeapps.cuevanahd.models.single_details.Video;
import com.movieeeapps.cuevanahd.network.RetrofitClient;
import com.movieeeapps.cuevanahd.network.apis.CommentApi;
import com.movieeeapps.cuevanahd.network.apis.FavouriteApi;
import com.movieeeapps.cuevanahd.network.apis.SingleDetailsApi;
import com.movieeeapps.cuevanahd.network.apis.SubscriptionApi;
import com.movieeeapps.cuevanahd.network.model.ActiveStatus;
import com.movieeeapps.cuevanahd.network.model.AdsConfig;
import com.movieeeapps.cuevanahd.network.model.FavoriteModel;
import com.movieeeapps.cuevanahd.service.DownloadWorkManager;
import com.movieeeapps.cuevanahd.utils.PreferenceUtils;
import com.movieeeapps.cuevanahd.utils.ApiResources;
import com.movieeeapps.cuevanahd.utils.ads.BannerAds;
import com.movieeeapps.cuevanahd.utils.Constants;
import com.movieeeapps.cuevanahd.utils.ads.PopUpAds;
import com.movieeeapps.cuevanahd.utils.ToastMsg;
import com.movieeeapps.cuevanahd.utils.Tools;
import com.movieeeapps.cuevanahd.utils.VolleySingleton;
...
//                    for (int e = 0 ; e>listSubtv.get())
    ...
    private void getActiveStatus(String userId) {
        ...
        Call<ActiveStatus> call = subscriptionApi.getActiveStatus(com.movieeeapps.cuevanahd.Config.API_KEY, userId);
